...
const Hero = () => {
  return (
    ...
    gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        <Image
          ...
          />
        <h1 className="bold-52 lg:vold-85">Putuk Truno Camp Area</h1>
        <p className="regular-16 mt-16 text-gray-30 xl:max-w-[520px]">
          We want to be on each of your journeys seeking the
          satisfication of seeing the incorruptible beauty of nature.
    ...
    <div className="relative flex flex-1 items-start">
        <div className="relative z-20 flex w-[260px] flex-col gap-8
          rounded-3xl bg-green-90 px-7 py-8">
            <div className="flex flex-col">
              ...
              <p className="bold-20 text-white">Aguas Calentes</p>
              </div>
              <div className="flexBetween">
                <div className="flex flex-col">
